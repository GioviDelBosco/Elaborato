...
--
-- Host: 127.0.0.1
-- Creato il: Mag 25, 2021 alle 10:44
...
INSERT INTO `biglietto` (`id_biglietto`, `id_utente`, `id_evento`, `prezzo`, `data`) VALUES
(1, 2, 2, '15.00', '2021-08-03'),
(2, 2, 2, '15.00', '2021-08-03'),
(3, 3, 5, '10.50', '2021-08-19');
...
--
ALTER TABLE `biglietto`
  MODIFY `id_biglietto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
